    ...
    <div className="flex flex-col min-h-screen min-w-full bg-gray-900">
      ...
      <section className="bg-gray-800 text-white py-16">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4">Welcome to D.K Modisane & N.Z Malgas</h1>
          <p className="text-lg md:text-xl mb-6">Empowering students through expert tutoring and mentoring services</p>
          <Link href="/about">
            <span className="bg-gray-700 text-white py-4 px-8 rounded-full font-semibold hover:bg-gray-200 hover:text-gray-900 transition duration-300">Learn More</span>
          </Link>
        </div>
      </section>
      ...
      <section id="mission-vision" className="py-16">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-extrabold text-center mb-8 text-white ">Our Key Aspects</h2>
      ...
      <section className="bg-gray-800 text-white py-16 text-center mt-8">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-extrabold mb-4 text-white">Ready to Achieve Your Goals?</h2>
          <p className="text-lg mb-6">Join us and take the first step towards academic success with expert guidance and support!</p>
          <Link href="/contact">
            <span className="bg-gray-700 text-white py-4 px-8 rounded-full font-semibold hover:bg-gray-200 hover:text-gray-900 transition duration-300 mt-4">Contact Us</span>
          </Link>
        </div>
      </section>
    </div>
